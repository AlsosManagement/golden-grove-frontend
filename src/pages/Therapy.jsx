      ...
      <section style={{
        ...
        <FadeIn>
          ...
          <p style={{ fontSize: "clamp(1rem, 2vw, 1.15rem)", color: "rgba(255,255,255,0.75)", maxWidth: 600, margin: "0 auto", lineHeight: 1.7 }}>
            Diverse evidence-based therapies and holistic practices tailored to support your healing.
          </p>
        </FadeIn>
      </section>
      ...
      <section className="section-pad" style={{ padding: "80px 24px", maxWidth: 1100, margin: "0 auto" }}>
        <FadeIn>
          ...
          <p style={{ fontSize: 15, color: B.gray, marginBottom: 50, maxWidth: 540 }}>
            Recovery requires multiple approaches. We tailor your treatment plan using a combination of these modalities.
          </p>
        </FadeIn>
